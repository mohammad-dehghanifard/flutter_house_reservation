...
import 'package:flutter_house_reservation/modules/auth/pages/auth_page.dart';
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      CustomButtonWidget(
                        onTap: () => buildController.selectedPage < 2? buildController.changePage() : Get.offAll(const AuthPage()),
